    ...
    <div className="relative w-full transition-all duration-300 transform hover:scale-101">
      {isAdotzeeChoice && (
        <div className="absolute -top-2 -left-2 z-10">
          <div className="flex items-center gap-1 px-3 py-1 bg-linear-to-r from-yellow-500 to-amber-500 text-white text-xs font-bold rounded-lg shadow-md">
      ...
      <div className="flex flex-col md:flex-row items-stretch border border-blue-100 p-4 bg-white rounded-xl shadow-md hover:shadow-lg">
        ...
        <div className="flex items-center flex-1">
          <div className="flex shrink-0 mr-4">
            <div className="w-12 h-12 flex items-center justify-center bg-linear-to-br from-blue-500 to-blue-600 rounded-full shadow text-white">
              <FontAwesomeIcon
        ...
        <div className="mt-4 md:mt-0 md:ml-4 flex items-center justify-end">
          <a
            href={`https://wa.me/918281060462?text=${encodeURIComponent(
              `I need to know about ${addonName ?? "this course"} in ${college}`
            )}`}
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center px-4 py-2 bg-linear-to-r from-blue-600 to-blue-700 text-white text-sm font-medium rounded-lg transition-colors duration-200 hover:from-blue-700 hover:to-blue-800 focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
          >
