...
type ServiceCardProps = {
    ...
    return (
      <a
       ...
       href={`https://wa.me/918281060462?text=I%20Need%20Know%20About%20Your%20${title}%20Scheme`}
        ...
        className="cursor-pointer p-6 bg-linear-to-r from-blue-500 to-indigo-500 text-white rounded-xl hover:scale-101 duration-300 transition transform shadow-xl hover:shadow-2xl hover:bg-linear-to-r hover:from-blue-600 hover:to-indigo-600"
        data-aos="fade-up" 
      >
  ...
  return (
    <>
      <section
        id="services"
        className="bg-linear-to-r from-blue-100 to-blue-300 text-white py-16 px-8 flex flex-col items-center"
        data-aos="fade-up"
      >
        <h2
