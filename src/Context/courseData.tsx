...
// import { CourseContextType } from "../pages/streams/CollegeList";
...
export interface ScienceCourse {
  category: string;
  addons: Addon[];
}

export interface CommerceCourses {
  category: string;
  addons: Addon[];
}

export interface HumanitiesCourses {
  category: string;
  addons: Addon[];
}
...
export interface CourseContextType {
  ...
  scienceCourses: ScienceCourse[];
  commerceCourses: CommerceCourses[];
  humanitiesCourses: HumanitiesCourses[];
...
export const CourseProvider = ({ children }: CourseProviderProps): JSX.Element => {
  const scienceCourses: ScienceCourse[] = [
    {
      category: " Nursing",
      addons: [
        {
  ...
  const commerceCourses: CommerceCourses[] = [
    {
      category: "BBA",
      addons: [
        {
  ...
  const humanitiesCourses : HumanitiesCourses[] = [
    {
      category: "BA",
      addons: [
  ...
  const collegeLocations : Record<string, string> = {
  ...
  const dotzeeChoiceColleges : string[] = [
    "JAIN UNIVERSITY",
    "YENEPOYA University",
    "MS RAMAIAH",
    "PRESIDENCY University",
  ...
  const paraAdotzeeChoiceColleges : string[] = [ "Yenapoya University","BGS Appolo","MS Ramaiah","RajaRajeshwari Medical College",];
