...
export default function Science(): JSX.Element {
  ...
  const { scienceCourses } = useCourse() as { scienceCourses: ScienceCourse[] };
  ...
  const filteredCourses: ScienceCourse[] = searchTerm.trim()
    ? scienceCourses
        .map((c) => ({
          ...c,
  ...
  const highlightText = (text: string, keyword: string): (string | JSX.Element)[] => {
    ...
    <>
      ...
      <div className="min-h-screen bg-linear-to-br from-[#6a85b6] to-[#bac8e0] pt-10 px-4 pb-10">
        ...
        <div className="text-center text-white mb-8">
          <h1 className="text-3xl md:text-4xl md:mt-15 mt-20 font-bold">
            Explore Science Career Options
          </h1>
          <p className="mt-2 text-lg flex justify-center items-center">
            <FontAwesomeIcon icon={faGraduationCap} className="mr-2" />
            Over <span className="text-yellow-400 font-bold mx-1">24+</span>{" "}
