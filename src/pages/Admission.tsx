...
function Admission() {
  ...
  const handleNavigation = (stream:string) => {
    navigate(`/${stream}`);
  };

  return (
    <div className=' bg-linear-to-br from-[#6a85b6] to-[#bac8e0]'>
      <Back />
      <Helmet>
      ...
      <div className=" bg-linear-to-br from-[#6a85b6] to-[#bac8e0] flex flex-col items-center pt-20">
